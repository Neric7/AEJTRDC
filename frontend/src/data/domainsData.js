...
export const domainsData = [
  {
    ...
    objectifs: [
      "Garantir l'accès à l'éducation pour les enfants marginalisés",
      "Distribuer des fournitures scolaires et parrainer la scolarité",
      "Offrir un accompagnement psychosocial",
      "Promouvoir l'inclusion sociale et l'épanouissement personnel"
    ]
  },
  {
    id: 2,
    ...
    objectifs: [
      "Supprimer les barrières sociales et physiques à l'accès à l'éducation",
      "Former les enseignants aux pratiques pédagogiques inclusives",
      "Distribuer des aides techniques aux enfants handicapés",
      "Sensibiliser la communauté à la non-discrimination",
      "Promouvoir l'intégration scolaire et sociale des enfants handicapés"
    ]
  },
  {
    id: 3,
    ...
    objectifs: [
      "Sensibiliser aux dangers du mariage précoce",
      "Offrir des alternatives éducatives aux filles à risque",
      "Renforcer les cadres légaux de protection",
      "Créer un environnement protecteur pour les filles"
    ]
  },
  {
    id: 4,
    ...
    objectifs: [
      "Sensibiliser aux risques du travail dans les mines",
      "Retirer les enfants des activités minières",
      "Offrir des alternatives économiques aux familles",
  ...
  },
  {
    ...
    objectifs: [
      "Fournir des informations précises sur la santé reproductive",
      "Offrir des services de santé adaptés aux adolescents",
      "Sensibiliser parents et enseignants",
      "Réduire les risques de grossesses précoces et d'IST"
    ]
  },
  {
    id: 6,
    ...
    objectifs: [
      "Utiliser le sport comme outil d'inclusion sociale",
      "Développer les compétences physiques et sociales",
      "Créer des infrastructures sportives accessibles",
  ...
  },
  {
    ...
    objectifs: [
      "Créer un environnement scolaire sûr pour les filles",
      "Mettre en place des mécanismes de signalement",
      "Former le personnel scolaire à la prévention",
      "Promouvoir des politiques scolaires inclusives"
    ]
  },
  {
    id: 8,
    ...
    objectifs: [
      "Identifier et retirer les enfants de situations d'exploitation",
      "Offrir un accompagnement pour la réintégration",
      "Renforcer les lois de protection de l'enfance",
      "Proposer des alternatives économiques aux familles"
    ]
  },
  {
    id: 9,
    ...
    objectifs: [
      "Assurer la continuité éducative en situation de crise",
      "Mettre en place des espaces d'apprentissage temporaires",
      "Offrir un accompagnement psychosocial",
      "Collaborer avec les acteurs humanitaires"
    ]
  },
  {
    id: 10,
    ...
    objectifs: [
      "Offrir des formations en entrepreneuriat",
      "Faciliter l'accès au crédit et au financement",
  ...
  },
  {
    ...
    objectifs: [
      "Former à la médiation et résolution de conflits",
      "Créer des espaces de dialogue communautaire",
      "Sensibiliser aux principes de bonne gouvernance",
      "Promouvoir la justice sociale et la démocratie"
    ]
  },
  {
    id: 12,
    ...
    objectifs: [
      "Améliorer la nutrition des communautés vulnérables",
  ...
  },
  {
    ...
    objectifs: [
      "Sensibiliser à la valeur de la biodiversité",
      "Mettre en œuvre des actions de reforestation",
      "Protéger les zones écologiques sensibles",
      "Promouvoir des pratiques économiques alternatives"
    ]
  }
];

// Fonction utilitaire pour obtenir un domaine par son ID
export const getDomaineById = (id) => {
  return domainsData.find(domaine => domaine.id === parseInt(id));
};

// Fonction pour obtenir un domaine par son slug
export const getDomaineBySlug = (slug) => {
  return domainsData.find(domaine => domaine.slug === slug);
};

// Fonction pour obtenir tous les domaines sauf celui spécifié
export const getAutresDomaines = (currentId) => {
  return domainsData.filter(domaine => domaine.id !== parseInt(currentId));
};

// Fonction pour obtenir tous les titres des domaines
export const getAllDomaineTitles = () => {
  return domainsData.map(({ id, titre, slug }) => ({ id, titre, slug }));
};

// Fonction pour obtenir les 3 derniers domaines (pour page d'accueil)
export const getRecentDomaines = (limit = 3) => {
  return [...domainsData].reverse().slice(0, limit);
};